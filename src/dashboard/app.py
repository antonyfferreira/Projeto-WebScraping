...
st.markdown(
    ...
    .header {
        ...
        align-items: center;
        padding: 10px;
        background-color: #9cafe6  /* Ajuste a cor de fundo conforme necessário */
    }
    .header img {
        height: 100px;
        margin-right: 30px; /* Espaçamento entre a imagem e o título */
    }
    .header h1 {
...
st.subheader("Top 10 marcas mais encontradas no site das páginas 01 até 10")
...
fig_bar = px.bar(
    ...
    y="Marca",
    orientation="h",
    color_discrete_sequence=["#617ed7"],
    height=400,
)
...
st.subheader("Top 10 marcas com maior preço médio das páginas 01 até 10")
...
st.subheader("Top 10 marcas com melhores avaliações das páginas 01 até 10")
